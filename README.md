...
- Черновой планировщик уведомлений: Celery каркас + Redis (команды в `docker compose`, задачи-рыбы в `app/tasks/reminders.py`), готово под интеграцию с Telegram/почтой.
...
- [x] Планировщик уведомлений (черновой): Celery + Redis, задачи-рыбы для чек-инов/мотивации.
